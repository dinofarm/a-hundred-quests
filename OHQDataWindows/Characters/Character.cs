...
namespace OHQData.Characters
{
    ...
    public abstract class Character : WorldObject
    {
        ...
        private void AddStandardCharacterIdleAnimations()
        {
            if (mapSprite != null)
            {
                mapSprite.AddAnimation(new Animation("IdleSouth", 3, 4,
                    MapIdleAnimationInterval, true));
                mapSprite.AddAnimation(new Animation("IdleWest", 5, 6,
                    MapIdleAnimationInterval, true));
                mapSprite.AddAnimation(new Animation("IdleNorth", 1, 2,
                    MapIdleAnimationInterval, true));
                mapSprite.AddAnimation(new Animation("IdleEast", 7, 8,
                    MapIdleAnimationInterval, true));
            }
        }
        ...
        private void AddStandardCharacterWalkingAnimations()
        {
            ...
            if (sprite != null)
            {
                sprite.AddAnimation(new Animation("WalkSouth", 3, 4,
                    MapWalkingAnimationInterval, true));
                sprite.AddAnimation(new Animation("WalkWest", 5, 6,
                    MapWalkingAnimationInterval, true));
                sprite.AddAnimation(new Animation("WalkNorth", 1, 2,
                    MapWalkingAnimationInterval, true));
                sprite.AddAnimation(new Animation("WalkEast", 7, 8,
                    MapWalkingAnimationInterval, true));
            }
        }
                ...
                Character existingInstance)
            {
                ...
                if (character.WalkingSprite != null)
                {
                    character.WalkingSprite.SourceOffset =
                        new Vector2(
                        character.WalkingSprite.SourceOffset.X - 20,
                        character.WalkingSprite.SourceOffset.Y - 20);
                }
